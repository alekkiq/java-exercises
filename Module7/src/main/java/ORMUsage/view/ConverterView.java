...
public class ConverterView extends Application {
    ...
    private NewCurrencyDialog newCurrencyDialog;
    ...
    public void start(Stage stage) {
        ...
        Button addNewCurrency = new Button("Add New Currency");
        ...
        VBox actions = new VBox(12, this.convertBtn, addNewCurrency);
        ...
        // build new currency dialog
        this.newCurrencyDialog = new NewCurrencyDialog(this.controller, stage);
        ...
        // new currency prompt
        addNewCurrency.setOnAction(event -> this.newCurrencyDialog.open());
